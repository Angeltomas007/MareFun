...
(() => {
  ...
  const dict = {
    en: {
      ...
      "marina.th.length": "Length Overall", "marina.th.day": "Per Day",
      ...
      "footer.blurb": "Luxury yacht charter and marina berth management across the Mediterranean, arranged with quiet precision since 2005.",
    ...
    it: {
      ...
      "marina.th.length": "Lunghezza F.T.", "marina.th.day": "Al Giorno",
      ...
      "footer.blurb": "Charter nautico di lusso e gestione ormeggi in tutto il Mediterraneo, con discreta precisione dal 2005.",
    ...
    fr: {
      ...
      "marina.th.length": "Longueur H.T.", "marina.th.day": "Par Jour",
      ...
      "form.contact": "Votre Coordonnée *", "form.contact.ph.email": "vous@exemple.com", "form.contact.ph.phone": "+33 0 00 00 00 00",
      ...
      "footer.blurb": "Location de yachts de luxe et gestion de places de marina en Méditerranée, avec une discrétion précise depuis 2005.",
