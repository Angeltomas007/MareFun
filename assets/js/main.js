...
(() => {
  ...
  const dict = {
    en: {
      ...
      "contact.lede": "Whether you're chartering for a week or berthing for a season, our team replies personally.",
    ...
    it: {
      ...
      "contact.lede": "Che stiate noleggiando per una settimana o ormeggiando per una stagione, il nostro team risponde personalmente.",
    ...
    fr: {
      ...
      "contact.lede": "Que vous louiez pour une semaine ou amarriez pour une saison, notre équipe répond personnellement.",
